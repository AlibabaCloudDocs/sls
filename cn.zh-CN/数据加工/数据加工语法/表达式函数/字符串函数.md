...
-   参数说明
    ...
    |encoding|String|否|编码格式，默认为utf8。支持`ASCII`。|
    |errors|String|否|错误信息，默认忽略。支持`strict`、`replace`、`xmlcharrefreplace` 。|
...
-   参数说明
    ...
    |encoding|任意（自动转为String）|否|编码格式，默认为utf8。 支持`ASCII`。|
    |errors|任意（自动转为String）|否|错误信息，默认忽略。 支持`strict`、`replace`、`xmlcharrefreplace` 。|
