...
-   参数说明
    ...
    |参数名称|参数类型|是否必填|说明|
    |----|----|----|--|
    |data|表格|是|搜索表格，表格某一列必须是搜索字符串。**说明：** 如果采用资源函数res\_rds\_mysql和res\_log\_logstore\_pull作为数据源，则为了提升处理性能，请尽量设置primary\_keys参数。如何设置，请参见[资源函数](/cn.zh-CN/数据加工/数据加工语法/表达式函数/资源函数.md)。 |
