...
|类别|子类|支持功能|
|--|--|----|
|资源管理|[Project和Logstore配置管理](/cn.zh-CN/应用中心（App）/Jupyter Lab/场景案例/批量创建Project和Logstore.md)|支持通过模板批量创建多个Project和Logstore。|
|[Logtail配置管理](/cn.zh-CN/应用中心（App）/Jupyter Lab/场景案例/常见资源管理.md)|通过模板创建Logtail配置，同时支持跨Project复制Logtail配置。|
