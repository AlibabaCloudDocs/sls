...
![访问流程](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/5377259951/p6443.png)
...
2.  调用阿里云登录服务接口获取日志服务登录Token。

    **说明：**

    -   STS返回的安全Token中可能包含特殊字符，请将特殊字符进行URL编码后再输入。
    -   由于Token有效期为3小时，建议您在自建Web设置链接，每次请求时生成新的登录Token，通过302请求返回进行跳转。
    请求示例：
