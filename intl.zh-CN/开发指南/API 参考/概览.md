...
|[Config](/intl.zh-CN/开发指南/API 参考/公共资源说明/Logtail配置.md)（配置）|[ListConfig](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/ListConfig.md)、[CreateConfig](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/CreateConfig.md)、[DeleteConfig](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/DeleteConfig.md)、[GetConfig](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/GetConfig.md)、[UpdateConfig](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/UpdateConfig.md)|
|[GetAppliedMachineGroups](/intl.zh-CN/开发指南/API 参考/Logtail配置相关接口/GetAppliedMachineGroups.md)（查询应用到的机器组）|
|[MachineGroup](/intl.zh-CN/开发指南/API 参考/公共资源说明/Logtail机器组.md)|[ListMachineGroup](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/ListMachineGroup.md)、[CreateMachineGroup](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/CreateMachineGroup.md)、[DeleteMachineGroup](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/DeleteMachineGroup.md)、[GetMachineGroup](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/GetMachineGroup.md)、[UpdateMachineGroup](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/UpdateMachineGroup.md)|
|[Apply](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/ApplyConfigToMachineGroup.md)、[Remove](/intl.zh-CN/开发指南/API 参考/Logtail机器组相关接口/RemoveConfigFromMachineGroup.md)（删除配置）|
...
|[Shard](/intl.zh-CN/开发指南/API 参考/公共资源说明/分区.md)（分区）|[ListShard](/intl.zh-CN/开发指南/API 参考/日志库相关接口/ListShards.md)、[SplitShard](/intl.zh-CN/开发指南/API 参考/日志库相关接口/SplitShard.md)、[MergeShards](/intl.zh-CN/开发指南/API 参考/日志库相关接口/MergeShards.md)|
|[PostLogStoreLogs](/intl.zh-CN/开发指南/API 参考/日志库相关接口/PutLogs.md)（写入日志）|
...
-   根据[Logtail配置](/intl.zh-CN/开发指南/API 参考/公共资源说明/Logtail配置.md)、[Logtail机器组](/intl.zh-CN/开发指南/API 参考/公共资源说明/Logtail机器组.md)信息收集日志。
