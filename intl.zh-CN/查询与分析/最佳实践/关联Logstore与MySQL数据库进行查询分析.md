...
-   已为日志字段创建索引。更多信息，请参见[配置索引](/intl.zh-CN/查询与分析/配置索引.md)。
...
2.  添加白名单。
    ...
    -   如果是RDS MySQL数据库，需添加白名单地址100.104.0.0/16、11.194.0.0/16和11.201.0.0/16。更多信息，详情请参见[设置IP白名单](/intl.zh-CN/RDS MySQL 数据库/数据安全/加密/设置白名单/设置IP白名单.md)。
