...
3.  创建SampleLogHubProcessor.java文件。
    ...
    更多信息请参见[Java](https://github.com/aliyun/aliyun-log-consumer-java)、[Python](https://github.com/aliyun/aliyun-log-python-sdk)及[Go](https://github.com/aliyun/aliyun-log-go-sdk/blob/master/consumer/README.md)。
...
3.  在**日志管理** \> **日志库**页签中，单击目标Logstore左侧的**![展开节点](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/0276119951/p53702.png)** \> **数据消费**。
