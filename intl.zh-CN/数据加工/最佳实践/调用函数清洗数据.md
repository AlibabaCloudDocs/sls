...
您可以使用[e\_drop](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/事件操作函数.md)函数或[e\_keep](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/事件操作函数.md)函数过滤日志，也可以使用[e\_if](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.mdsection_dhk_ius_2q8)函数与DROP参数、[e\_if\_else](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.md)函数与DROP参数过滤日志。
...
您可以使用[e\_set](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/字段赋值函数.md)函数为日志空缺字段赋值。
...
-   子场景1：原字段不存在或者为空时，为字段赋值。
    ...
    mode参数取值请参见[字段提取检查与覆盖模式](/intl.zh-CN/数据加工/数据加工语法/通用参考/字段提取模式.md)。
...
-   子场景2：使用[GROK函数](/intl.zh-CN/数据加工/数据加工语法/表达式函数/GROK函数.md)简化正则表达式，提取字段内容。
...
一般情况下，推荐您使用[e\_compose](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.mdsection_zr0_ghx_vie)函数进行重复判断和操作。
...
日志的字段和字段值在加工过程中，始终都是字符串形式，非字符串类型的数据会被自动转化为字符串类型。因此在调用函数时，要注意各个函数能接收的参数类型。更多信息，请参见[语法简介](/intl.zh-CN/数据加工/数据加工语法/语法简介.md)。

-   子场景1：调用[op\_add](/intl.zh-CN/数据加工/数据加工语法/表达式函数/操作符函数.md)函数进行字符拼接和数据相加。
...
-   子场景2：运用[v](/intl.zh-CN/数据加工/数据加工语法/表达式函数/事件检查函数.md)函数和[ct\_int](/intl.zh-CN/数据加工/数据加工语法/表达式函数/转换函数.md)函数进行类型转换并调用[op\_mul](/intl.zh-CN/数据加工/数据加工语法/表达式函数/算术函数.md)函数进行数据相乘。
...
-   子场景3：调用[dt\_parse](/intl.zh-CN/数据加工/数据加工语法/表达式函数/日期时间函数.mdsection_yug_wml_n2u)函数和[dt\_parsetimestamp](/intl.zh-CN/数据加工/数据加工语法/表达式函数/日期时间函数.md)函数将字符串或日期时间转换为标准时间。

    dt\_totimestamp函数接收的参数类型为日期时间对象，不是字符串。因此需要调用dt\_parse函数将time1的字符串值类型转化为日期时间对象类型。您也可以直接使用dt\_parsetimestamp函数，它既能接收日期时间对象，也能接收字符串。更多信息，请参见[日期时间函数](/intl.zh-CN/数据加工/数据加工语法/表达式函数/日期时间函数.md)。
...
部分SLS DSL表达式函数对输入的参数有一定要求，如果不满足，数据加工窗口会报错或返回默认值。当日志中存在必要而残缺字段时，您可以在[op\_len](/intl.zh-CN/数据加工/数据加工语法/表达式函数/操作符函数.md)函数中填充默认值。
...
推荐使用[e\_if](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.mdsection_dhk_ius_2q8)函数或[e\_switch](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.md)函数进行日志判断。更多信息，请参见[流程控制函数](/intl.zh-CN/数据加工/数据加工语法/全局操作函数/流程控制函数.md)。
